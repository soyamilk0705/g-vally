...
function board_update(){
	//alert("수정");
	location.href="updateform.khs?num=${b.num}&pg=${pg}";
	
}
function board_delete(){
	//alert("삭제");
	location.href="deleteform.khs?num=${b.num}&pg=${pg}";
}
function board_reply(){
	//alert("답변");
	location.href="replyform.khs?num=${b.num}&pg=${pg}";
}
